...
type TemplateCommand = 'build' | 'run' | 'runInteractive' | 'attach' | 'logs' | 'composeUp' | 'composeDown' | 'composeUpSubset' | 'composeDownSubset' | 'composePull' | 'composePullSubset';
...
export async function selectComposeCommand(context: IActionContext, folder: vscode.WorkspaceFolder, composeCommand: 'up' | 'down' | 'upSubset' | 'downSubset' | 'pull' | 'pullSubset', configurationFile?: string, detached?: boolean, build?: boolean): Promise<VoidCommandResponse> {
    ...
    switch (composeCommand) {
        ...
        case 'downSubset':
            ...
            break;
        case 'pull':
            template = 'composePull';
            break;
        case 'pullSubset':
            template = 'composePullSubset';
            break;
        case 'upSubset':
        default:
