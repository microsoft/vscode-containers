# Contributing to Container Tools extension for VS Code
...
To contribute bug fixes, features, or design changes:
  ...
  * Install [ESLint](https://marketplace.visualstudio.com/items?itemName=dbaeumer.vscode-eslint) and [esbuild Problem Matchers](https://marketplace.visualstudio.com/items?itemName=connor4312.esbuild-problem-matchers) for Visual Studio Code.
